...
namespace SisControleVenda.Controllers
{
    public class NivelDeAcessoesController : Controller
    {
        ...
        public NivelDeAcessoesController(SisControleVendaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("NivelDeAcessoID,Nivel")] NivelDeAcesso nivelDeAcesso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NivelDeAcessoID,Nivel")] NivelDeAcesso nivelDeAcesso)
        {
